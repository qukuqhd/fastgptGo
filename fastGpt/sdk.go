...
func (s *FastGptSdkClient) UploadLinkFileSet(req *UpLoadLinkFileReq) (*UploadLinkFileResp, error) {
	...
	err := s.httpCli.SendObjParse(http.MethodPost, s.baseUrl+"core/dataset/collection/create/link", req, &resp)
	return &resp, err
}
...
func (s *FastGptSdkClient) UploadTextSet(req *UploadTextSetReq) (*UploadTextSetResp, error) {
	...
	err := s.httpCli.SendObjParse(http.MethodPost, s.baseUrl+"core/dataset/collection/create/text", req, &resp)
	return &resp, err
}
...
func (s *FastGptSdkClient) GetAppChatHistory(req *GetAppChatHistoryReq) (*GetAppChatHistoryResp, error) {
	...
	err := s.httpCli.SendObjParse(http.MethodGet, s.baseUrl+"core/chat/getHistories", req, &resp)
	return &resp, err
}
...
func (s *FastGptSdkClient) GetAppChatHistoryRecords(req *GetChatRecordsReq) (*GetChatRecordsResp, error) {
	...
	err := s.httpCli.SendObjParse(http.MethodPost, s.baseUrl+"core/chat/getPaginationRecords", req, &resp)
	return &resp, err
}
